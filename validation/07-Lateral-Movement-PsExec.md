...
* **Test Performed:** Test 2 - Use PsExec to execute a command on a remote host
* **Command Executed:**
...
* **Data Source:** Windows Security Event Log / System Log
* **Expected EventID:** 4697 (Security) and 7045 (System) - A service was installed in the system.
...
* **Rule Name:** PsExec Service Installation
* **Test Result:** Triggered = YES
* **False Positives:** Moderate. PsExec is a legitimate Sysinternals administration tool. However, in mature environments, its use should be replaced by WinRM/PowerShell Remoting, making every `PSEXESVC` startup highly suspicious.
...
See the **lateral_movement_psexec.yml** file in the repository for the complete rule.
